...
class KaggleSentiment(Dataset):
    ...
    def __init__(self, mode="regression",
        ...
        super(KaggleSentiment, self).__init__("kaggle_sentiment",
                lang="en", size="medium",
        ...
        super(KaggleSentiment, self).set_provides(self.fields)
        super(KaggleSentiment, self).set_fields(self.fields)
        super(KaggleSentiment, self).initialize_splits(self.line_processor)
