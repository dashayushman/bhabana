...
from bhabana.pipeline import TransformerRegressor
...
def get_pipeline(pipeline_config, vocab_size, pretrained_word_vectors,
                 max_seq_len):
    pipeline = TransformerRegressor(n_src_vocab=vocab_size, n_max_seq=max_seq_len,
...
def run_pipeline(experiment_name, dataset, setup, pipeline,
    ...
    trainer = GangaTrainer(experiment_name=experiment_name,
