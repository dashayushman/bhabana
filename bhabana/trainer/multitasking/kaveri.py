...
from bhabana.pipeline import MemoryMultiTask
...
def get_pipeline(pipeline_config, vocab_size, pretrained_word_vectors,
                 n_classes):
    pipeline = MemoryMultiTask(vocab_size=vocab_size, n_output_neurons=n_classes,
...
def run_pipeline(experiment_name, dataset, setup, pipeline,
    ...
    trainer = KaveriTrainer(experiment_name=experiment_name,
